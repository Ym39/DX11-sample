...
BumpMapShaderClass::BumpMapShaderClass() : m_layout(nullptr),m_lightBuffer(nullptr),m_matrixBuffer(nullptr),m_pixelShader(nullptr),m_sampleState(nullptr),m_vertexShader(nullptr)
{
}
...
bool BumpMapShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"Bumpmap.vs", L"Bumpmap.ps");
	if (!result)
	{
		return false;
	}
...
bool BumpMapShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, ID3D11ShaderResourceView** textureArray, XMFLOAT3 lightDirection, XMFLOAT4 diffuseColor)
{
	bool result;
...
bool BumpMapShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename , WCHAR* psFilename)
{
	...
	CD3D11_BUFFER_DESC lightBufferDesc;
...
bool BumpMapShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, ID3D11ShaderResourceView** textureArray, XMFLOAT3 lightDirection, XMFLOAT4 diffuseColor)
{
	HRESULT result;
